...
// 设置机械臂的ip地址
const std::string LEFT_ROBOT_IP = "192.168.11.60"; 
const std::string RIGHT_ROBOT_IP = "192.168.11.61";
...
ExampleArgs ParseExampleArguments(int argc, char *argv[])
{
    ...
    options.add_options()
        ("ip", "IP address of destination", cxxopts::value<std::string>()->default_value("192.168.11.61"))
        ("h,help", "Print help")
...
ExampleArgs ParseExampleArguments_right(int argc, char *argv[])
{
    cxxopts::Options options(argv[0], "Kortex example");
...
ExampleArgs ParseExampleArguments_left(int argc, char *argv[])
{
    cxxopts::Options options(argv[0], "Kortex example");
    
    options.add_options()
        ("ip", "IP address of destination", cxxopts::value<std::string>()->default_value("192.168.11.60"))
        ("h,help", "Print help")
        ("u,username", "username to login", cxxopts::value<std::string>()->default_value("admin"))
        ("p,password", "password to login", cxxopts::value<std::string>()->default_value("admin"))
    ;
