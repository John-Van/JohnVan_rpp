...
std::vector<double> left_data_x_aug;
std::vector<double> left_data_y_aug;
std::vector<double> left_data_z_aug;
...
void draw_plot() {
    try {
        ...
        // 角度折线
        plt::named_plot("left_x_aug", left_data, left_data_x_aug, "r--");
        plt::named_plot("left_y_aug", left_data, left_data_y_aug, "g--");
        plt::named_plot("left_z_aug", left_data, left_data_z_aug, "b--");
        
        // 设置图表属性
        plt::title("realtime_monitor - point_num: " + std::to_string(left_data.size()));
        plt::xlabel("timepoint");
        plt::ylabel("value");
        plt::grid(true);
        plt::legend();
...
void update_plot() {
    ...
    left_data_x_aug.push_back(LeftControllerEuler[0]);
    left_data_y_aug.push_back(LeftControllerEuler[1]);
    left_data_z_aug.push_back(LeftControllerEuler[2]);
    ...
    if (left_data.size() > MAX_DATA_POINTS) {
        ...
        left_data_x_aug.erase(left_data_x_aug.begin());
        left_data_y_aug.erase(left_data_y_aug.begin());
        left_data_z_aug.erase(left_data_z_aug.begin());
    }
